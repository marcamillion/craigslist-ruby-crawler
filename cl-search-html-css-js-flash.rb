...
html_gigs_path = "output/client-side/#{today}/html-gigs-#{today}.html"
css_gigs_path = "output/client-side/#{today}/css-gigs-#{today}.html"
javascript_gigs_path = "output/client-side/#{today}/javascript-gigs-#{today}.html"
flash_gigs_path = "output/client-side/#{today}/flash-gigs-#{today}.html"
